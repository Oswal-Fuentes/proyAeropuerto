            ...
            <div class="row">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group" id="div-txt-numeroModelo-avion" >
                          <label class="control-label" for="txt-numeroModelo-avion">Numero Modelo:</label>
                          <input type="text" class="form-control" id="txt-numeroModelo-avion">
                        </div>
                    </div>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <table class="table table-striped table-hover" id="avion">
                                <th></th>
                    ...
                    <div class="panel-footer">
                    <button class="btn btn-primary btn-xs" id="btn-nuevo-avion-editar"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button>
